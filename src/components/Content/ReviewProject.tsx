...
export interface IReviewProjectProps {
    dispatch: any,
    learnerProfile: any,
    main: any
}

class ReviewProject extends React.Component<IReviewProjectProps> {
...
export default connect(mapStateToProps)(ReviewProject)